  ...
  bn: {
    ...
    groups: [
      ...
      { title: "🔒 নিরাপত্তা ও স্কেল", items: [
        ...
        { iconName: "Globe", title: "দুই ভাষা সাপোর্ট", desc: "বাংলা + English — Hijri, Bangla digits, locale-aware date/number formatting।" },
      ]},
    ],
  },
  en: {
    ...
    groups: [
      ...
      { title: "🔒 Security & Scale", items: [
        ...
        { iconName: "Globe", title: "Bilingual support", desc: "Bangla + English — Hijri, Bangla digits, locale-aware date/number formatting." },
      ]},
    ],
  },
  ur: {
