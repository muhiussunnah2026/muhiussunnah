...
export default async function SmsTemplatesPage({ params }: PageProps) {
                ...
                <Card key={t.id}>
                  <CardContent className="p-4">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <DeleteTemplateButton schoolSlug={schoolSlug} id={t.id} />
                    </div>
                  </CardContent>
                </Card>
              ))}
          ...
          <Card>
            <CardContent className="p-5">
              ...
              <TemplateForm
                ...
                schoolName={membership.school_name_bn ?? membership.school_name_en ?? ""}
              />
            </CardContent>
          </Card>
        </aside>
