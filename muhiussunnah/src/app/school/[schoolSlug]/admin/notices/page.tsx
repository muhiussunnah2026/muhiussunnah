  ...
  return (
    <>
      <PageHeader
        ...
        actions={
          <Link
            href={`/school/${schoolSlug}/admin/notices/new`}
      ...
      {list.length === 0 ? (
        <EmptyState
          ...
          primaryAction={
            <Link href={`/school/${schoolSlug}/admin/notices/new`} className={buttonVariants({ className: "bg-gradient-primary text-white" })}>
              নতুন নোটিশ তৈরি
            </Link>
          }
