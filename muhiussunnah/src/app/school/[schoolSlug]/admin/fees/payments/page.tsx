...
export default async function PaymentsLogPage({ params }: PageProps) {
  ...
  return (
    <>
      ...
      />
      <FeesSubNav schoolSlug={schoolSlug} active="payments" />
                ...
                <TableBody>
                  {payments.map((p) => (
                    <TableRow key={p.id}>
                      ...
                      <TableCell>
                        {p.students ? (
                          <Link href={`/school/${schoolSlug}/admin/students/${p.students.id}`} className="hover:underline">
                            {p.students.name_bn}
                          </Link>
                        ) : "—"}
                      </TableCell>
                      <TableCell className="font-mono text-xs">
                        {p.invoice_id ? (
                          <Link href={`/school/${schoolSlug}/admin/fees/invoices/${p.invoice_id}`} className="text-primary hover:underline">
