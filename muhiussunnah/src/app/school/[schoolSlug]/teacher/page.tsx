  ...
  return (
    <>
      ...
      <EmptyState
        ...
        primaryAction={
          <a href={`/school/${schoolSlug}/teacher/attendance`} className="rounded-md bg-gradient-primary px-4 py-2 text-sm font-medium text-white">
            Attendance নিন
          </a>
        }
        secondaryAction={
          <a href={`/school/${schoolSlug}/teacher/assignments`} className="rounded-md border border-border px-4 py-2 text-sm">
