                  ...
                  <TableBody>
                    {invoices.map((inv) => (
                      <TableRow key={inv.id} className="cursor-pointer">
                        <TableCell>
                          <Link href={`/admin/fees/invoices/${inv.id}`} className="font-mono text-xs underline-offset-4 hover:underline">
                            {inv.invoice_no}
                          </Link>
                        ...
                        <TableCell>
                          {inv.students ? (
                            <Link href={`/admin/students/${inv.students.id}`} className="font-medium hover:underline">
